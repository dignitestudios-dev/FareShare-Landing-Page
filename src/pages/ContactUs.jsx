...
const ContactUs = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (name == "") {
      ...
      setError("Subject cannot be left empty.");
    } else if (message == "") {
      setError("Message cannot be left empty.");
    } else {
      setLoading(true);
      axios
        .post("https://backend.faresharellc.com/landing/contactUs", {
          name: name,
          email: email,
          subject: subject,
          description: message,
  ...
  return (
    <>
      <Navbar />
      <section class="py-4 lg:py-24">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div class="grid lg:grid-cols-2 grid-cols-1 gap-x-24">
            <div class="flex items-center lg:mb-0 mb-10">
              <div class="">
                <h4 class="text-[#c00000] text-base font-medium leading-6 mb-4 lg:text-left text-center">
                  Contact Us
                </h4>
                ...
                <form onSubmit={handleSubmit}>
                  <input
                    ...
                    class="w-full h-14 shadow-sm text-gray-600 placeholder-text-400 text-lg font-normal leading-7 rounded-full border border-gray-200 focus:outline-none py-2 px-4 mb-4"
                    placeholder="Name"
                  />
                  <input
                    type="email"
                  ...
                  <textarea
                    ...
                    class="w-full h-48 shadow-sm resize-none text-gray-600 placeholder-text-400 text-lg font-normal leading-7 rounded-2xl border border-gray-200 focus:outline-none px-4 py-4 mb-4"
                    placeholder="Message"
                  ></textarea>
                  <button
                    type="submit"
                    class="w-full h-12 text-center text-white text-base font-semibold leading-6 rounded-full bg-[#c00000] shadow transition-all duration-700 hover:bg-[#c00000d8]"
                  >
            ...
            <div class="lg:max-w-xl w-full h-[600px] hidden  lg:flex items-center justify-center  bg-cover bg-no-repeat bg-[url('https://img.freepik.com/premium-photo/elegant-red-white-backgrounds-stylish-look_1199394-45689.jpg?size=626&ext=jpg&ga=GA1.1.1828858886.1716668774&semt=ais_hybrid')] ">
              <div class="">
            ...
            {error && <Error isOpen={error} setIsOpen={setError} />}
            {success && <Success isOpen={success} setIsOpen={setSuccess} />}
          </div>
        </div>
      </section>
    </>
